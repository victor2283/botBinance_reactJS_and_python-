...
class MainWindow(QMainWindow):
    ...
    def update_ui(self, data):
        ...
        self.label_price.setText(f"{data['price_market']}")
        color = "green" if data["price_market"] > data["last_price_market"] else "red"
        self.label_price.setStyleSheet(f"color: {color};")
        
        self.label_ear.setText(f"{data['ear']}")
        self.label_alerts.setText(f"{data['alerts']}")
        self.label_msg.setText(f"{data['msg']}")

        # Actualizar gráfico de Matplotlib
        self.update_chart(candles=data["candles"], indicators= data["indicators"])
