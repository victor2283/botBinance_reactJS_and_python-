...
import datetime
import time
from sync_time import Synchronize_time
...
class BotBinance:
    ...
    def update_data(self):
        ...
        smaS = self.SMA(closes= closes_serie, timeperiod=sPd)
        smaM = self.SMA(closes=closes_serie, timeperiod=mPd)
        smaL = self.SMA(closes=closes_serie, timeperiod=lPd)
